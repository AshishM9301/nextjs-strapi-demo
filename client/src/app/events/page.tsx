...
import { EventProps, CardProps } from "@/types";
...
export default async function AllEventsRoute({
    ...
    const { event, blocks } = await loader('you-want-to-stay-tuned-for-our-events');

    return (
        <div className="container">
            <div className="event-page">
                <EventSignupForm blocks={blocks} eventId={event.documentId} startDate={event.startDate} price={event.price} image={event.image} />
            </div>
            <ContentList
                headline="All Events"
                path="/api/events"
